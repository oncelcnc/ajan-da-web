  ...
  return (
    <div onClick={handleClick} style={{
      ...
      <div style={{
        ...
        <div style={{position:"absolute", left:0, top:0, bottom:0, width:7, background:"rgba(0,0,0,0.25)", borderRight:"1px solid rgba(255,255,255,0.05)"}} />
        <div style={{position:"absolute", top:0, left:7, right:0, height:2, background:"rgba(255,255,255,0.15)"}} />
        <div style={{
        ...
        <div style={{position:"absolute", right:0, top:2, bottom:2, width:3, background:"linear-gradient(90deg, #e8ddd0, #f5f0ea, #e8ddd0)", borderRadius:"0 4px 4px 0"}} />
      </div>
      {lifted && (
        <div style={{
    ...
    <div style={{
      ...
      <div style={{flex:1, display:"flex", flexDirection:"column", justifyContent:"center", padding:"0 16px 20px", position:"relative", zIndex:2}}>
        ...
        <div style={{position:"relative", marginBottom:32}}>
          ...
          <div style={{
            height:14,
            background:"linear-gradient(180deg, #8B5E3C 0%, #6B4423 40%, #5a3518 100%)",
            borderRadius:3,
            boxShadow:"0 4px 12px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.1)"
          }}>
            <div style={{height:3, background:"rgba(255,255,255,0.08)", borderRadius:"3px 3px 0 0"}} />
          </div>
        ...
        <div style={{opacity:0.25}}>
          <div style={{height:40, display:"flex", alignItems:"flex-end", padding:"0 24px", gap:6}}>
            {[40,55,48,62,44,50,38,52].map((h,i) => (
